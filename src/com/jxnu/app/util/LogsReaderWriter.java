...
/**
 * Created by puchunwei on 16/2/11.
 */
public class LogsReaderWriter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        File file = new File("/Users/puchunwei/");
        System.out.println(file.exists());
        System.out.println(file.isDirectory());
        System.out.println( readFromFile("/Users/puchunwei/logs/log.log", null));
    ...
    public boolean writeIntoFile(String log, String filePath, boolean isAppend) {
